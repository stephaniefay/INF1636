...
public class Coordenada extends JPanel {
...

	{
		...
		aux.colocaVizinho("Groelândia");
		aux.colocaVizinho("Vancouver");
				
		lstAmericaNorte.add(aux);
		
		lstTerritorios.add(aux = new Territorio("Groelândia", new Ponto[] {
		...
		lstTerritorios.add(aux = new Territorio("Québec", new Ponto[] {
		...
		lstTerritorios.add(aux = new Territorio("África do Sul", new Ponto[] { new Ponto(528.4, 545.4),
		...
		aux.colocaVizinho("África do Sul");
		aux.colocaVizinho("Somália");
		aux.colocaVizinho("Nigéria");
		lstAfrica.add(aux);
		
		lstTerritorios.add(aux = new Territorio("Argélia", new Ponto[] {
		...
		aux.colocaVizinho("Argélia");
		aux.colocaVizinho("Somalia");
		aux.colocaVizinho("Nigéria");
		aux.colocaVizinho("Jordânia");
		aux.colocaVizinho("Romênia");

		lstAfrica.add(aux);
		
		lstTerritorios.add(aux = new Territorio("Nigéria", new Ponto[] {
				new Ponto(425.3, 410.1),
		...
		lstTerritorios.add(aux = new Territorio("Somália", new Ponto[] {
		...
		aux.colocaVizinho("Arábia Saudita");
		aux.colocaVizinho("África do Sul");
		aux.colocaVizinho("Angola");
		aux.colocaVizinho("Nigéria");
		aux.colocaVizinho("Egito");
		...
		aux.colocaVizinho("Argélia");
		aux.colocaVizinho("França");

		lstEuropa.add(aux);
		
		lstTerritorios.add(aux = new Territorio("França", new Ponto[] {
		...
		aux.colocaVizinho("Reino Unido");
		aux.colocaVizinho("Itália");
		aux.colocaVizinho("Suécia");
		
		lstEuropa.add(aux);
		
		lstTerritorios.add(aux = new Territorio("Itália", new Ponto[] {
		...
		aux.colocaVizinho("França");
		aux.colocaVizinho("Suécia");
		aux.colocaVizinho("Polônia");
		aux.colocaVizinho("Romênia");

		lstEuropa.add(aux);
		
		lstTerritorios.add(aux = new Territorio("Polônia", new Ponto[] {
		...
		aux.colocaVizinho("Itália");
		aux.colocaVizinho("Ucrânia");
		aux.colocaVizinho("Romênia");
		aux.colocaVizinho("Letônia");
		lstEuropa.add(aux);
		...
		lstTerritorios.add(aux = new Territorio("Romênia", new Ponto[] {
				new Ponto(567.5, 237.9),
				new Ponto(555.8, 259.4),
		...
		lstTerritorios.add(aux = new Territorio("Suécia", new Ponto[] {
		...
		aux.colocaVizinho("França");
		aux.colocaVizinho("Itália");
		aux.colocaVizinho("Estônia");
		lstEuropa.add(aux);
		
		lstTerritorios.add(aux = new Territorio("Ucrânia", new Ponto[] {
		...
		lstTerritorios.add(aux = new Territorio("Arábia Saudita", new Ponto[] {
		...
		aux.colocaVizinho("Indonésia");
		aux.colocaVizinho("Tailândia");
		aux.colocaVizinho("Índia");
		aux.colocaVizinho("Coréia do Sul");
		lstAsia.add(aux);
		
		lstTerritorios.add(aux = new Territorio("Cazaquistão", new Ponto[] {
		...
		aux.colocaVizinho("Sibéria");
		aux.colocaVizinho("Rússia");
		aux.colocaVizinho("Letônia");
		aux.colocaVizinho("Turquia");
		aux.colocaVizinho("China");
		aux.colocaVizinho("Mongólia");
		aux.colocaVizinho("Japão");
		lstAsia.add(aux);
		
		lstTerritorios.add(aux = new Territorio("Mongólia", new Ponto[] {
				new Ponto(906.1, 246.4),
		...
		aux.colocaVizinho("Mongólia");
		aux.colocaVizinho("Coréia do Norte");
		aux.colocaVizinho("Coréia do Sul");
		aux.colocaVizinho("Índia");
		aux.colocaVizinho("Paquistão");
		aux.colocaVizinho("Turquia");
		aux.colocaVizinho("Cazaquistão");
		lstAsia.add(aux);
		
		lstTerritorios.add(aux = new Territorio("Coréia do Norte", new Ponto[] { 
		...
		lstTerritorios.add(aux = new Territorio("Coréia do Sul", new Ponto[] {
				new Ponto(914.9, 326.1),
		...
		lstTerritorios.add(aux = new Territorio("Estônia", new Ponto[] {
		...
		lstTerritorios.add(aux = new Territorio("Índia", new Ponto[] {
		...
		lstTerritorios.add(aux =  new Territorio("Irã", new Ponto[] {
		...
		lstTerritorios.add(aux = new Territorio("Japão", new Ponto[] {
		...
		lstTerritorios.add(aux = new Territorio("Jordânia", new Ponto[] {
		...
		lstTerritorios.add(aux = new Territorio("Letônia", new Ponto[] {
				new Ponto(610.2, 144.5),
		...
		lstTerritorios.add(aux = new Territorio("Paquistão", new Ponto[] {
				new Ponto(763.8, 387.8),
				new Ponto(739.9, 387.8),
		...
		lstTerritorios.add(aux = new Territorio("Rússia", new Ponto[] {
		...
		lstTerritorios.add(aux = new Territorio("Sibéria", new Ponto[] {
		...
		lstTerritorios.add(aux =  new Territorio("Síria", new Ponto[] {
		...
		lstTerritorios.add(aux =  new Territorio("Tailândia", new Ponto[] {
				new Ponto(915.5, 350.0),
				new Ponto(885.3, 350.0),
		...
		lstTerritorios.add(aux =  new Territorio("Autrália", new Ponto[] {
		...
		aux.colocaVizinho("Nova Zelândia");
		aux.colocaVizinho("Indonésia");
		aux.colocaVizinho("Perth");
		lstOceania.add(aux);
		
		lstTerritorios.add(aux =  new Territorio("Indonésia", new Ponto[] {
		...
		aux.colocaVizinho("Austrália");
		aux.colocaVizinho("Bangladsh");
		aux.colocaVizinho("Nova Zelândia");
		aux.colocaVizinho("Índia");
		lstOceania.add(aux);
		
		lstTerritorios.add(aux =  new Territorio("Nova Zelândia", new Ponto[] {
				...
				for(Territorio t : lstTerritorios) {
						if(t.getPoligono().contains(e.getX(), e.getY())) {
							if ( flag == 0 && (t.retJogador()==posicao)) {
								if (t.qtdPecas() == 1) {
									if (ataque != true) {
										JOptionPane.showMessageDialog(j, "Esse território possui apenas uma unidade, você não pode movimentá-la!", "Aviso", JOptionPane.INFORMATION_MESSAGE, img);
										break;
									}
								}
								...
								if (t.qtdPecas() < 4 ) {
									if (ataque == true) {
										JOptionPane.showMessageDialog(j, "Esse território possui poucas unidades, não pode atacar!", "Aviso", JOptionPane.INFORMATION_MESSAGE, img);
										break;
									}
								}
								t1 = t;
								...
								if ( t == t1 ) {
									if (ataque == true) {
										JOptionPane.showMessageDialog(j, "Ataque Inválido (Mesmo Território)", "Aviso", JOptionPane.INFORMATION_MESSAGE, img);
										break;
									}
									else {
										JOptionPane.showMessageDialog(j, "Movimentação Inválida (Mesmo Território)", "Aviso", JOptionPane.INFORMATION_MESSAGE, img);
										break;
									}
								}
								else if (t.retJogador() == posicao) {
									if (ataque == true) {
										JOptionPane.showMessageDialog(j, "Você não pode se atacar!", "Aviso", JOptionPane.INFORMATION_MESSAGE, img);
										break;
									}
									else {
										int teste = 0;
										...
										if (teste == 0) {
											JOptionPane.showMessageDialog(j, "Esses territórios não são vizinhos!", "Aviso", JOptionPane.INFORMATION_MESSAGE, img);
										}
										flag = 0;
									...
									if (ataque == true) {
										JOptionPane.showMessageDialog(j, "Selecione um território seu para ataque!", "Aviso", JOptionPane.INFORMATION_MESSAGE, img);
										break;
									}
									else {
										JOptionPane.showMessageDialog(j, "Selecione um território seu para a movimentação!", "Aviso", JOptionPane.INFORMATION_MESSAGE, img);
										break;
									}
								}
						}
	...
	private void VizinhosTer (Territorio t) {
		...
		for (String m : t.lstVizinhos()) {
			...
			if (t1.retName() == m) {
				...
				JOptionPane.showMessageDialog(j, "Ataque Inválido: Países não são vizinhos!",
